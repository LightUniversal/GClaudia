...
const ProductsScreen = () => {
  ...
  return (
    <div className="  border-t border-slate-50 ">
      <h2 className=" mx-auto bg-slate-900 font-medium text-2xl p-6 my-5 flex items-center text-white">
      ...
      {isLoading ? (
        ...
        <div className="flex justify-between  w-full flex-wrap items-center gap-3 md:w-5/6 px-3 ">
          {data.products.map((product) => (
              ...
              className="one shadow-xl bg-white rounded-xl  mx-auto px-2 py-3 md:w-1/4 my-3 w-full"
            >
